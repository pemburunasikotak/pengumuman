...
export async function searchResult(data) {
  try {
    ...
    const mapped = {
      ...
      nilaiAkhir: parseFloat(found.nilai_akhir) || 0,
      kpu: found.kpu || 0,
      ppu: found.ppu || 0,
      kmbm: found.kmbm || 0,
      pk: found.pk || 0,
...
export async function verifyDocument(id) {
  try {
    ...
    const mapped = {
      ...
      tanggalUjian: parseBirthDate(found.tanggal_ujian),
      nilaiAkhir: parseFloat(found.nilai_akhir) || 0,
      kpu: parseInt(found.kpu) || 0,
      ppu: parseInt(found.ppu) || 0,
      kmbm: parseInt(found.kmbm) || 0,
      pk: parseInt(found.pk) || 0,
      literasiIndonesia: parseInt(found.literasi_indonesia) || 0,
      literasiInggris: parseInt(found.literasi_inggris) || 0,
      penalaranMatematika: parseInt(found.penalaran_matematika) || 0,
      foto: found.foto_url && found.foto_url.startsWith('http') ? found.foto_url : null,
      qrCodeUrl: found.qr_code_url,
      status: found.status_kelulusan.toUpperCase(),
      programStudi: found.program_studi,
